...
> **This project is no longer maintained. QuantConnect now offers native code generation through their AI assistant, MIA. For extracting ideas from quantitative research papers, tools like Elicit or Perplexity can be used in combination with MIA to build a more efficient research-to-algorithm pipeline.**
